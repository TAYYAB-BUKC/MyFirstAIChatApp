namespace MyFirstAIChatApp
{
	public partial class WebChatApp
	{
		private string summarizationPrompt = """
            ...
            3. Craft a concise summary of 5 sentences that captures the main points of the document, reflecting its primary themes or focus areas.

            # Output Format

            Provide the summary in plain text as 5 complete sentences.
